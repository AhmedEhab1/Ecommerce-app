...
import com.macaria.app.databinding.FavoriteItemHorizontalBinding;
...
public class ProductsHorizontalAdapter extends RecyclerView.Adapter<ProductsHorizontalAdapter.StoryViewHolder> {
    private List<ProductModel> data = new ArrayList<>();
    private Context context;
    private ProductsListener listener;
    private boolean isFinishedLoading;

    public ProductsHorizontalAdapter(Context context, ProductsListener listener) {
    ...
    public StoryViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new StoryViewHolder(FavoriteItemHorizontalBinding.inflate(LayoutInflater.from(parent.getContext()), parent, false));
    }
    ...
    public void onBindViewHolder(@NonNull StoryViewHolder holder, @SuppressLint("RecyclerView") int position) {
        try {
            ...
            holder.binding.discount.setText(data.get(position).getPercentage());
    ...
    public static class StoryViewHolder extends RecyclerView.ViewHolder {
        FavoriteItemHorizontalBinding binding;

        public StoryViewHolder(@NonNull FavoriteItemHorizontalBinding binding) {
