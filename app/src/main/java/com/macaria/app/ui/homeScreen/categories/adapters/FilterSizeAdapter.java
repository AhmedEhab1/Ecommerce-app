...
public class FilterSizeAdapter extends RecyclerView.Adapter<FilterSizeAdapter.StoryViewHolder> {
    ...
    public FilterSizeAdapter(Context context, FilterDialogListener listener) {
        ...
        try {
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    listener.onSizeClicked(data.get(position).getId());
